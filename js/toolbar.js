...
function showJTopoToobar(stage){
    ...
    +'&nbsp;<input type="radio" name="modeRadio" value="drag" id="r3"/><label for="r3" id="label-r3" "><span > <span class="glyphicon glyphicon-wrench" style="font-size: 22px;display: inline-block;transform: translate(31px,-25px);"></span>拖动画布</span></label>'
...
var JTopoToobarEvent={
    "label_r2":function(){
        ...
        $('#label-r2 span.glyphicon').addClass('toolclass');
        $('#label-r4 span.glyphicon').removeClass('toolclass');
        $('#label-r3 span.glyphicon').removeClass('toolclass');
        // 删除虚拟线
    ...
    "label_r4":function(){
        ...
        ////$('#linestyle').fadeIn();
        $('#label-r4 span.glyphicon').addClass('toolclass')
        $('#label-r2 span.glyphicon').removeClass('toolclass');
        $('#label-r3 span.glyphicon').removeClass('toolclass');
    },
    "label_r3":function(){
        $('#label-r3 span.glyphicon').addClass('toolclass');
        $('#label-r4 span.glyphicon').removeClass('toolclass');
        $('#label-r2 span.glyphicon').removeClass('toolclass')
    }
}
