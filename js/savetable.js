...
$("#modal-sdnC-form-2-btn-getIP").click(function(){
    ...
    $.getJSON('http://10.10.1.67:8080/net/index.php/topo_manage/topo_manage/get_sdn_controller_port?callback=?',data,function(msg){
...
var restore = {
    ...
    switch_restore:function(data){
        ...
        $.getJSON('http://10.10.1.67:8080/net/index.php/topo_manage/topo_manage/produce_switch_port_info?callback=?',data,function(data){
            if( data && data.retCode == 0 && data.eth_list ){
